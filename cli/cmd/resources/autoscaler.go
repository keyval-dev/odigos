	...
	return &rbacv1.ClusterRole{
		...
		Rules: []rbacv1.PolicyRule{
			...
			},
			{
				...
				Resources: []string{"addclusterinfos", "deleteattributes", "renameattributes", "probabilisticsamplers", "redactions"},
			},
			{
				Verbs: []string{
					"get",
				...
				APIGroups: []string{"actions.odigos.io"},
				Resources: []string{"addclusterinfos/status", "deleteattributes/status", "renameattributes/status", "probabilisticsamplers/status", "redactions/status"},
			},
			{
				Verbs: []string{
					"get",
